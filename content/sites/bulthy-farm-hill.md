...
location:
  ...
  latlong: 52.714788, -3.023883
sensitivities:
  - sensitivity: If you intend to visit you must provide advance notice by joining
      the Whatsapp group using this
      link <https://chat.whatsapp.com/HOe7SAYbq3W8G6jjf9T6XL?mode=gi_t>
  - sensitivity: If the Quad Bike is active with any of their sporting activities,
      flying and especially bottom landing may need to be suspended subject to
      their binding decision.
  - sensitivity: >-
      Middletown Hill – is much higher but we have NO permission to launch or
      land on it, please avoid.
...
launchesAndLanding: >-
  ...
  There are usually flags around the landing area (from the Quad Bike centre), use these to judge real wind direction rather than the launch area.
flying: >-
  Small low level phone masts on the hill to avoid
